...
class MainWindow(QMainWindow):
    ...
    def showUser_Manual(self):
        webbrowser.open("https://drive.google.com/file/d/1KiexoB27QOgvCoCHKzPy4kLsnNb_iPtN/view", new=2)
    ...
    def showCredits(self):
        webbrowser.open("https://drive.google.com/file/d/1UrJnkOqIw7V_hjMQ8-YxjzZA2HOJsH5O/view", new=2)
    
    def showAbout_Us(self):
        webbrowser.open("https://drive.google.com/file/d/1lXqpoG5tSoH7b8a04EQVWVk65HpqgdPc/view", new=2)
